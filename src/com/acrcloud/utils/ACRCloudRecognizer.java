...
public class ACRCloudRecognizer {
    ...
    public String recognizeByFile(String filePath, int startSeconds)
    {
        String result = ACRCloudStatusCode.NO_RESULT;
        try {
            System.out.println("Inside recognizeByFile");
    ...
    private String doRecogize(byte[] fp) {
        System.out.println("Inside doRecogize");
        String method = "POST";
    ...
    public static void main(String[] args) {
        ...
        File file = new File("C:\\Users\\BALU\\Downloads\\My Skype Received Files\\Track.mp3");
